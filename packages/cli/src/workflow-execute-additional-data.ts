...
export async function getBase(
	...
	return {
		...
		executeWorkflow,
		restApiUrl: `${urlBaseWebhook}/1/${globalConfig.endpoints.rest}`,
		instanceBaseUrl: `${urlBaseWebhook}/1`,
		formWaitingBaseUrl: `${urlBaseWebhook}/1/${globalConfig.endpoints.formWaiting}`,
		webhookBaseUrl: `${urlBaseWebhook}/1/${globalConfig.endpoints.webhook}`,
		webhookWaitingBaseUrl: `${urlBaseWebhook}/1/${globalConfig.endpoints.webhookWaiting}`,
		webhookTestBaseUrl: `${urlBaseWebhook}/1/${globalConfig.endpoints.webhookTest}`,
